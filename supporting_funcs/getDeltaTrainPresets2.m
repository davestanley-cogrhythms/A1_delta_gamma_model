...
function s = getDeltaTrainPresets2(freq,shift,Tend,dt,pulse_num,ap_pulse_delay,preset_number)

% This is a modified version of getDeltaTrainPresets, without onset and
% offset values. These are calculated later on.
% Generates a train of delta functions.

% On units:
% freq in units of 1/(1000*dt)
% Everything else is in same units as T and dt.
% Generally, this follows DynaSim conventions, so freq can be in Hz and
% everything else can be in ms. 
