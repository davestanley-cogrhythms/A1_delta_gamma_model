...
%     end
    ...
    currfname = 'kr'; 
    currfigname = '113a_drive_FS_PPSTim';
...
%         print(gcf,'-dpng',fullfile(basepath,sp,savenames{i}))
    ...
    mycomment = ['Im going to drive FS cells with PPStim for now also, so that they can always be aligned with RS (for tuning only).'];
