...
%     end
    ...
    currfname = 'kr'; 
    currfigname = '129c_sweep_RSPPStim_raise_gRSFS';
...
%         print(gcf,'-dpng',fullfile(basepath,sp,savenames{i}))
    ...
    %
    mycomment = ['Swept through RS PPStim again. Turned off FS PPStim. Increased gRSFS back to 1.5. Also allowed PPStim to start at 300 to give longer settling time'];
