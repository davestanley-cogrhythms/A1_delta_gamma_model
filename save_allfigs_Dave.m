...
%     end
    ...
    currfname = 'kr'; 
    currfigname = '121b_sweep3_highnoise_hetero_lowgap';
...
%         print(gcf,'-dpng',fullfile(basepath,sp,savenames{i}))
    ...
    %%
    mycomment = ['Sweeping through gRSFS, gFSFS, and gFSRS synapses. For case with high noise, heterogenious synapses, and lowered gap junction connectivity.'];
