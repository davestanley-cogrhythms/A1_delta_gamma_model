...
%     end
    ...
    currfname = 'kr'; 
    currfigname = '141a_redo_gLTSRS_sweep';
...
%         print(gcf,'-dpng',fullfile(basepath,sp,savenames{i}))
    ...
    %
    mycomment = ['Sweep LTS->RS feedback. Blocked gLTS->FS for now. Plan is to eliminatefancy double LTS spike by reducing LTS->RS.'];
