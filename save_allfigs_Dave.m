...
%     end
    ...
    currfname = 'kr'; 
    currfigname = '136b_sweep_single_LTS_gNa_gK';
...
%         print(gcf,'-dpng',fullfile(basepath,sp,savenames{i}))
    ...
    %
    mycomment = ['Swept gLTS through a variety of Jlts, for different gNa, gK, and gM combinations. Seems I will just leave things as default. '];
