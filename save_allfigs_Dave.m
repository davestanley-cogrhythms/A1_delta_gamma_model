...
%     end
    ...
    currfname = 'kr'; 
    currfigname = '114a_made_iPeriodicPulses_AMPA';
...
%         print(gcf,'-dpng',fullfile(basepath,sp,savenames{i}))
    ...
    mycomment = ['I replaced the traditional current injection version of iPeriodicPulses with an AMPA version, which generates slightly broadened pulses of AMPA conductance.'];
