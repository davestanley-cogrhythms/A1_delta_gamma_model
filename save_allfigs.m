...
%     if ~exist('currfigname'); currfigname = '3_single_comp_only_Mcurr'; end
    ...
    currfname = 'kr'; 
    currfigname = '55b_got_aperiodic_working';
...
%         print(gcf,'-dpng',fullfile(basepath,sp,savenames{i}))
    ...
    %%
    mycomment = ['Got gamma oscillator working. Needs large pulse to get AP. Needs large IApp to get 40 Hz. Fig1-2 gamma AP. Figs3-8 increasing IApp from 0 to -2.'];
    currd = pwd;
    cd ..
    system('git add *');
