...
%     if ~exist('currfigname'); currfigname = '3_single_comp_only_Mcurr'; end
    ...
    currfname = 'kr'; 
    currfigname = '88e_play_IBNG_NMDA';
...
%         print(gcf,'-dpng',fullfile(basepath,sp,savenames{i}))
    ...
    %%
    mycomment = ['Tried increasing the gNMDA from IB to NG cells, in order to get a bigger effect of NMDA blockade on IB 40 Hz firing.'];
