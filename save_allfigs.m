...
%     if ~exist('currfigname'); currfigname = '3_single_comp_only_Mcurr'; end
    ...
    currfname = 'kr'; 
    currfigname = '64b_Eleaknoisy_PPstim_RS';
...
%         print(gcf,'-dpng',fullfile(basepath,sp,savenames{i}))
    ...
    mycomment = ['Now test RS cells individually. Varying current injection (representing NMDA). Figs1-2 and 3-5 use simply different sweep ranges'];
