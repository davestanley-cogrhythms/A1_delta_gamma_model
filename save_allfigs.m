...
%     if ~exist('currfigname'); currfigname = '3_single_comp_only_Mcurr'; end
    ...
    currfname = 'kr'; 
    currfigname = '79b_sweep_IB_RS_AMPA_NMDA';
...
%         print(gcf,'-dpng',fullfile(basepath,sp,savenames{i}))
    ...
    mycomment = ['Varied IB->RS AMPA and NMDA strengths again. It seems that IB->RS NMDA has a huge effect on disrupting synchrony and preventing the AP pulse. Best with NMDA = 0.'];
