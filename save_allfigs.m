...
%     if ~exist('currfigname'); currfigname = '3_single_comp_only_Mcurr'; end
    ...
    currfname = 'kr'; 
    currfigname = '58a_supra_gamma_match_deep_gamma';
...
%         print(gcf,'-dpng',fullfile(basepath,sp,savenames{i}))
    ...
    %%
    mycomment = ['Got 1:1 match between supraficial gamma and deep gamma. Also added NMDA synapse, but not active yet.'];
    currd = pwd;
    cd ..
    system('git add *');
