...
%     if ~exist('currfigname'); currfigname = '3_single_comp_only_Mcurr'; end
    ...
    currfname = 'kr'; 
    currfigname = '78a_deltagamma_adjust_PPStim_IB';
...
%         print(gcf,'-dpng',fullfile(basepath,sp,savenames{i}))
    ...
    %%
    mycomment = ['Swept through range of IB PPStim values. Note that RS-FS cells actually fire at 20 Hz. Value of -3 seems good; 4 is better.'];
