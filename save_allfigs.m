...
%     if ~exist('currfigname'); currfigname = '3_single_comp_only_Mcurr'; end
    ...
    currfname = 'kr'; 
    currfigname = '65_Gamma_net_sparse';
...
%         print(gcf,'-dpng',fullfile(basepath,sp,savenames{i}))
    ...
    mycomment = ['Now test full gamma network with heterogeneous RS and FS cells. It seems to work with firing becoming less sparse over time. Firing rates still seems somewhat low but its fine.'];
