...
%     if ~exist('currfigname'); currfigname = '3_single_comp_only_Mcurr'; end
    ...
    currfname = 'kr'; 
    currfigname = '88d_play_with_IB_PPStim';
...
%         print(gcf,'-dpng',fullfile(basepath,sp,savenames{i}))
    ...
    mycomment = ['Removed RS->NG synapse. Tried making IB cells more excitable under NMDA block conditions by including a PPStim current to IB cells.'];
