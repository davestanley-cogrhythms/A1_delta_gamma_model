...
%     if ~exist('currfigname'); currfigname = '3_single_comp_only_Mcurr'; end
    ...
    currfname = 'kr'; 
    currfigname = '76h_as_before_different_range2';
...
%         print(gcf,'-dpng',fullfile(basepath,sp,savenames{i}))
    ...
    mycomment = ['Different range from previous. Swept NG PPSTim -1 through -3 and FS->IB through [ 0.4000    0.5000    0.6000    0.7000]. Figs 5-7 AP pulse; Figs 8-12 no AP.'];
