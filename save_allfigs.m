...
%     if ~exist('currfigname'); currfigname = '3_single_comp_only_Mcurr'; end
    ...
    currfname = 'kr'; 
    currfigname = '76c_gamma_delta_single_sims';
...
%         print(gcf,'-dpng',fullfile(basepath,sp,savenames{i}))
    ...
    %%
    mycomment = ['Varied a bunch of things, greedily optimizing; see readme for details.. Generally I found that FS are too inhibited relative to RS. Also not sure what to do with IB PPStim.'];
