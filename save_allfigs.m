...
%     if ~exist('currfigname'); currfigname = '3_single_comp_only_Mcurr'; end
    ...
    mycomment = ['Removed Poisson noise for now. Step through range of gGABAaii [0 0.5 1 2 4]. Trying to see max FS->FS conductance that can not cause "skipping" APs.'];
    currd = pwd;
    cd ..
    system('git add *');
