...
%     if ~exist('currfigname'); currfigname = '3_single_comp_only_Mcurr'; end
    currfname = 'kramer_IB'; 
    currfigname = '10b-Carracedo_compare';
    ...
    %%
    mycomment = ['Plotted Destexhe model response for various boxes of GABA B injection. We will need to reduce Tmax in Austins synapse.'];
    currd = pwd;
    cd ..
    system('git add *');
