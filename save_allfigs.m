...
%     if ~exist('currfigname'); currfigname = '3_single_comp_only_Mcurr'; end
    ...
    currfname = 'kr'; 
    currfigname = '88b_test_NMDA_block';
...
%         print(gcf,'-dpng',fullfile(basepath,sp,savenames{i}))
    ...
    mycomment = ['Analysed effects of NMDA block for various parameter regimes. It didnt really produce an increase in gamma power.'];
