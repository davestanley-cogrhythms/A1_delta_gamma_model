...
for f = 1:(files_dim1*files_dim2)
    ...
    if ~isempty(files{f})
        ...
        plotyy(data(selected).time, data(selected).deepRS_V, data(selected).deepRS_iPeriodicPulseBensVersion_input)
