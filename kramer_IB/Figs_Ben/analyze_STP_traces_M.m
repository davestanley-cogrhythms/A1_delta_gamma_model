function analyze_STP_traces_M(data_info_file)
...
sims = [1, 1]; no_sims = length(sims);

fields = [1 3; 1 4; 1 3];

x_labels = {'$I_{m}$ Activation', '$I_{m}$ Activation'};

y_labels = {'$\Delta$ ($I_{m}$ Activation)', '$I_{Na_{P}}$ Activation'};
...
for s = 1:no_sims
    ...
    if s == 1
        ...
        activation_2 = diff(activation_1);
