...
switch chosen_cell
    case '0a'
        ...
        %% Compile - compile for just delta oscillator + translaminar FS
        clear s
        f = 1;
        s{f} = struct;
        s{f}.save_figures = 0;
    ...
    case '4b'
        ...
        s{f} = struct;
        s{f}.save_figures = 1; s{f}.save_combined_figures = 1; s{f}.save_shuffle_figures = 1; s{f}.plot_on = 0; s{f}.plot_on2 = 0; s{f}.do_visible = 'off'; s{f}.save_simfiles_to_repo_presim = true; s{f}.save_everything_to_repo_postsim = true; s{f}.do_commit = 0;
        s{f}.repo_studyname = ['DeltaFig4b_lakatos'  num2str(f) '' namesuffix];
        s{f}.sim_mode = 1;
        s{f}.pulse_mode = 5;
        s{f}.vary = { '(RS,FS,LTS,IB,NG,dFS5,tFS5)','PPmaskfreq',[0.01,fliplr([[1:11]-6]*.3+2)];...
            };
        ...
        datapf4b = kramer_IB_function_mode(s{f},f);
    ...
    case '5a2'
        ...
        s{f} = struct;
        s{f}.save_figures = 1; s{f}.save_combined_figures = 1; s{f}.save_shuffle_figures = 1; s{f}.plot_on = 0; s{f}.plot_on2 = 0; s{f}.do_visible = 'off'; s{f}.save_simfiles_to_repo_presim = true; s{f}.save_everything_to_repo_postsim = true; s{f}.do_commit = 0;
        s{f}.repo_studyname = ['DeltaFig5a2_iPAC'  num2str(f) '' namesuffix];
        s{f}.sim_mode = 18;
        s{f}.pulse_mode = 5;
...
%         datapf6a = kramer_IB_function_mode(s{f},f);
    ...
    case '8a'
        ...
        s{f}.tspan=[0 2400]; s{f}.PPonset = 500; s{f}.PPoffset = 1700; s{f}.xlims_range = [300 s{f}.tspan(2)];
        % s{f}.random_seed = 100;
        a = clock; s{f}.random_seed = floor(a(end-1)*60+a(end));    % Random seed locked to current clock
        s{f}.include_tFS5 = include_tFS5_global;
    ...
    case '8d'
        ...
        s{f}.Nfs = 20;
        s{f}.vary = {'IB','PP_gSYN',[0:0.1:0.7]; ...
                     'dFS5->IB','g_SYN',[0:0.04:0.3]/s{f}.Nfs;...
            };
        s{f}.maxNcores = maxNcores; if maxNcores > 1; s{f}.parallel_flag = 1; else; s{f}.parallel_flag = 0; end
...
%         s{f}.IB_onset2=100;
        ...
        if strcmp(namesuffix,'blkgAR')
            % Do this one if AR current is off
            s{f}.vary = { ...
                '(IB,RS,FS,LTS,NG,dFS5,tFS5)','PPmaskshift',[800:50:1450,3000,3001]-700;...
            };
        else
            % Do this one otherwise
            s{f}.vary = { ...
...
%% % % % % % % % % % % % % % % % % % For supplementary figures % % % % % % % % % % % % % % % % % % % % 
    ...
    case '1a3' 
        ...
        s{f}.pulse_mode = 1; s{f}.pulse_train_preset = 0;
        s{f}.tspan=[0 2400]; s{f}.PPonset = 700; s{f}.PPoffset = 2400; s{f}.xlims_range = [400 s{f}.tspan(2)];         % Onset at 400 
        s{f}.PPoffset = Inf;
        s{f}.random_seed = 5;
        s{f}.include_tFS5 = include_tFS5_global;
