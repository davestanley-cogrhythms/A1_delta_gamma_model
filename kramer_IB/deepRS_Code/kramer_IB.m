...
switch sim_mode
    case 1                                                                  % Everything default, single simulation
        vary = {% 'deepRS', 'PPfreq', 1:23;...
                ...
                'deepRS', 'I_app', -7:-.1:-11;... % 3.5*Cm_Ben*(-.15:-.015:-.3)/.25;... % Cm_Ben*(-.125)/.25;... % 
                % 'deepRS', 'PPstim', 0;...
...
% % % % % % % % % % ##4.1 Run simulation % % % % % % % % % %
data=SimulateModel(spec,'tspan',tspan,'dt',dt,'downsample_factor',dsfact,'solver',solver,'coder',0,'random_seed',random_seed,'compile_flag',compile_flag,'vary',vary,'cluster_flag',0,'parallel_flag',1,'verbose_flag',1);
