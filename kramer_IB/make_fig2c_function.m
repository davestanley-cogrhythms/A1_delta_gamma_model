function make_fig2c_function(name)
...
if length(highfreqs) == 8

    plot_indices = [1:3 6:8];
    
else
    
    plot_indices = [1:length(highfreqs)];
...
selected_FMPhighfreq = highfreqs; % [9 11 13 14]; % 13.5 18 27];
selected_FMPlowfreq = lowfreqs; % [3 2 1 .5]; % 2 1.5 1];
