...
simulation_vary = {...%'deepRS', 'mechanism_list', '+iVariedPulses';...
    ...
    [.325:1.3:6.5; 13.675:-1.3:7.5; .0125:.05:.25; .775:-.1:.3; zeros(1, 5); 1:-.2:.05; ceil(.5:2:10); floor(50:-2:40.5)];...  
    % 'deepRS', '(VPlowfreq, VPhighfreq)', [.1, .25, .5, 1, 2, 4, 6.5; 30, 25, 20, 17, 13, 10, 7.5]; % [.5:.5:6.5; fliplr(7.5:.5:13.5)]; % 
    'deepRS', 'VPstim', [0 -.1:-.5:-2.5];...
    'deepRS', 'PPstim', 0;...
    };
...
sim_name = sprintf('parsing_traces_%s_%d', Today, Now(4));
