...
%             'RS->NG','gNMDA',[1:1:6]/Nib;...
    ...
    case 20     % For tuning excitatory reset of delta oscillator (includes tuning PPOnset)
        ...
        vary = { ...
            %'IB','PP_gSYN',[0,0.5]; ...
            'NG->IB','gGABAB',[.7:.1:1.1]/Nng;...
            'IB','stim2',[0.0:0.5:1.5]; ...
            '(IB,RS,FS,LTS,NG,dFS5,tFS5)','PPmaskshift',[700,600,500];...
            'IB','PP_gSYN',[0,0.1,0.2,0.3]; ...            
            };
        ...
        vary = { ...
            %'IB','PP_gSYN',[0,0.5]; ...
            'NG->IB','gGABAB',[.7:.2:1.1]/Nng;...
            'IB','stim2',[-0.5:0.5:1.5]; ...
            '(IB,RS,FS,LTS,NG,dFS5,tFS5)','PPmaskshift',[800,700,600,500,10000];...
...
%             };
    ...
    case 21     % For tuning excitatory reset of delta oscillator (includes tuning PPOnset)
        ...
        vary = { ...
            ...
            'IB','stim2',[0:0.5:1.5]; ...
            'tFS5->IB','g_SYN', [2,3]/Ntfs5;...
            '(IB,RS,FS,LTS,NG,dFS5,tFS5)','PPmaskshift',[500,600,700,10000];...
            };
        ...
        vary = { ...
            ...
            'IB','stim2',[-0.5:0.5:1.5]; ...
            'IB->IB','gNMDA', [7,9,11]/Nib;...
            '(IB,RS,FS,LTS,NG,dFS5,tFS5)','PPmaskshift',[400,500,600,700,10000];...
            };
