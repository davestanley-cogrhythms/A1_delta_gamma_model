...
switch sim_mode
    ...
    case 2  % Periodic pulses to deepRS cells, ranging over frequency.
        vary = {'deepRS', 'PPfreq', [.25 .5 1 1.5 2:23];... 1:10;... 
            ...
            'deepRS', 'I_app', -5.5:-.5:-7;... -7.5:-.5:-9.5;... -6.5:-.5:-8.5;... % -Cm_factor*(.6:.05:.7);... % Cm_factor*(0:-.015:-.15);... % -7:-.1:-11;... % 3.5*Cm_Ben*(-.15:-.015:-.3)/.25;... % 
            'deepRS', 'PPduty', .25;...
    ...
    case 4 % Inhibition-based theta, FI curve.
        ...
        vary = {
            ...
            'deepRS', 'I_app', 0:-.1:-20;... -20;... -1:-1:-15;... 0:-.1:-20;... -1:-1:-8;... % -1;... % [-9.1 -10 -10.2];... % -10;... %
    ...
    case 6 % Inhibition-based theta, frequency-modulated input.
        ...
        vary = {
            ...
            'deepRS', 'gKs', 0;... 'mechanism_list', '-iKs';...
            % 'deepRS', 'gKCa', 0;... 'mechanism_list', '-iKCaT';...
            'deepRS', 'I_app', -5.5:-.5:-9.5;... % [-9.1 -10 -10.2];... % -10;... % 
            'deepRS', 'FMPstim', 0:-.2:-1;... % 0;... % -1;... % 
            'deepRS', '(FMPhighfreq, FMPlowfreq)', [9 10 15 20; 1 .5 .25 .1];...
            'deepRS', 'PPstim', 0;...
            };
    ...
    case 8 % PRC input.
       tspan = [0 3000];
       vary = {
           'deepRS', 'STPshift', 200;... 0:50:800;...
           'deepRS', 'STPstim', -10;... 0:-10:-50;... % -Cm_factor*(0:.05:.15);... % Cm_Ben*(-.025:-.025:-.1)/.25;...
           'deepRS', 'I_app', -7.5;... :-.25:-8.5;... % -Cm_factor*(.6:.05:.7);... % Cm_factor*(0:-.015:-.15);... % -7:-.1:-11;... % -7.5;... % 3.5*Cm_Ben*(-.15:-.015:-.3)/.25;... %
