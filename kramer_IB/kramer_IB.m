...
if save_figures
    ...
    plot_options = {...
                    {universal_options{:},'plot_type','rastergram','crop_range',xlims_range,'population','all'}, ...        
%                     {universal_options{:},'plot_type','power','crop_range',[xlims_range(1), tspan(end)],'xlims',[0 80],'ylims',[0,1],'do_mean',true,'population','RS'}, ...                    
                    
                    };
%                 {universal_options{:},'plot_type','power','crop_range',[xlims_range(1), tspan(end)],'xlims',[0 80],'population','IB'}, ...
%                 {universal_options{:},'plot_type','FRpanel','crop_range',xlims_range,'population','all'}, ...         
%                 {universal_options{:},'plot_type','waveform','crop_range',xlims_range,'population','all','max_num_overlaid',2,'ylims',[-85 45]}, ...     
                  
%                 {universal_options{:},'plot_type','waveform','crop_range',xlims_range,'plot_handle',@xp1D_matrix_plot_with_AP}, ...
%                 {universal_options{:},'plot_type','waveform','crop_range',xlims_range}, ...
%                     {universal_options{:},'plot_type','waveform','crop_range',xlims_range,'plot_handle',@xp1D_matrix_plot_with_AP}, ...

%                     {universal_options{:},'plot_type','waveform','crop_range',xlims_range,'population','all','force_last','populations','do_overlay_shift',true,'overlay_shift_val',40,'plot_handle',@xp1D_matrix_plot_with_AP}, ...
...
%                 {universal_options{:},'plot_type','imagesc','crop_range',xlims_range,'population','LTS','zlims',[-100 -20],'plot_handle',@xp_matrix_imagesc_with_AP}, ...
%                 {universal_options{:},'plot_type','power','crop_range',[xlims_range(1), tspan(end)],'xlims',[0 80],'population','RS'}, ...
%               {universal_options{:},'plot_handle',plot_func,'Ndims_per_subplot',3,'force_last',{'populations','variables'},'population','all','variable','all','ylims',[-.3 1.2],'lock_axes',false}, ...
                    %{universal_options{:},'plot_type','waveform','crop_range',xlims_range,'variable','Mich','do_mean',true}, ...    
