...
spec.populations(i).mechanism_list = {'IBdaitonic','IBanoise','IBiNaF','IBiKDR','IBiAR','IBdaiM','IBdaiCaH','IBdaleak'};
...
spec.populations(i).size = N;
spec.populations(i).equations = {['V''=(current)/Cm; V(0)=' num2str(IC_V) ]};
spec.populations(i).mechanism_list = {'IBsitonic','IBanoise','IBiNaF','IBiKDR','IBsleak'};
spec.populations(i).parameters = {...
...
spec.populations(i).size = N;
spec.populations(i).equations = {['V''=(current)/Cm; V(0)=' num2str(IC_V) ]};
spec.populations(i).mechanism_list = {'IBdbiPoissonExp','IBdbitonic','IBanoise','IBiNaF','IBiKDR','IBiAR','IBdbiM','IBdbiCaH','IBdbleak'};
...
spec.populations(i).size = N;
spec.populations(i).equations = {['V''=(current)/Cm; V(0)=' num2str(IC_V) ]};
spec.populations(i).mechanism_list = {'IBaitonic','IBanoise','IBiNaF','IBiKDR','IBaiM','IBaleak'};
spec.populations(i).parameters = {...
