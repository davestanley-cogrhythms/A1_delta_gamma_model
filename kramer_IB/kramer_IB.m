...
switch sim_mode
    case 1                                                                  % Everything default, single simulation
        vary = {% 'deepRS', 'PPfreq', 1:23;...
                % 'deepRS', 'PPstim', Cm_Ben*(-.05)/.25;...
                % 'deepRS', 'PPduty', .25;...
                % 'deepRS', 'kernel_type', 25;...
                'deepRS', 'I_app', Cm_Ben*(-.15:-.015:-.3)/.25;... % Cm_Ben*(-.125)/.25;... % 
                'deepRS', 'gKCa', Cm_Ben*.009/.25;... % Cm_Ben*(.005:.004:.013)/.25;... % 
                % 'deepRS', 'gKs', Cm_Ben*[.084:.01:.124]/.25;... % Cm_Ben*(-.7:-.01:-1)/.25}; % % [];
                % 'deepRS', 'gCa', Cm_Ben*[.02:.01:.05]/.25;...
                };
