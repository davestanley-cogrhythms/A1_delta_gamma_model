...
switch sim_mode
    case 1 % Tonic currents of varying strengths, applied to deepRS cells.
        vary = {'deepRS', 'I_app', -7:-.2:-11;... 0:-.1:-20;... 
            'deepRS', 'Inoise', .25;... 0:.05:.25;...
            'deepRS', 'PPstim', 0;...
            'deepRS', 'FMPstim', 0;...
            };
    
    case 2  % Periodic pulses to deepRS cells, ranging over frequency.
        vary = {'deepRS', 'PPfreq', 1:10;... [.25 .5 1 1.5 2:23];...
            'deepRS', 'PPstim', 0:-.2:-1;... 0:-2:-10;... 0:-.5:-2;... % -Cm_factor*(0:.05:.15);... % Cm_Ben*(-.025:-.025:-.1)/.25;...
            'deepRS', 'I_app', -7.5;... -6.5:-.5:-8.5;... % -Cm_factor*(.6:.05:.7);... % Cm_factor*(0:-.015:-.15);... % -7:-.1:-11;... % 3.5*Cm_Ben*(-.15:-.015:-.3)/.25;... % 
            'deepRS', 'PPduty', .25;...
    ...
    case 4 % Inhibition-based theta.
        ...
        tspan = [0 6000];
        vary = {
            'deepRS', 'I_app', -20;... -1:-1:-15;... 0:-.1:-20;... -1:-1:-8;... % -1;... % [-9.1 -10 -10.2];... % -10;... %
            'deepFS->deepRS', 'g_SYN', 0;... [.6 .9 1.2];... .1:.1:.5;...
            'deepRS->deepFS', 'g_SYN', .001:.001:.01;... [.01 .05];... [.05 .1 .2 .3];...
            'deepFS->deepRS', 'tauDx', 30;... 45;...
            'deepFS->deepRS', 'tauRx', .25;...
            'deepRS', 'gl', .8;... 
...
%             'deepRS', 'PPfreq', [.25 .5 1 1.5 2:23];...
            'deepRS', 'PPstim', 0;... 0:-.5:-2;... % -Cm_factor*(0:.05:.15);... % Cm_Ben*(-.025:-.025:-.1)/.25;...
%             'deepRS', 'PPduty', .25;...
%             'deepRS', 'kernel_type', 25;... % 7;... %
%             'deepRS', 'PPnorm', 0;... % 1;...
            % 'deepRS', '(FMPhighfreq, FMPlowfreq)', [9 10 15 20; 1 .5 .25 .1];...
    ...
    case 5 % Periodic input to IB & NG delta network.
    ...
    case 6 % PRC input.
       ...
       vary = {
           ...
           'deepRS', 'I_app', -6.5:-.5:-8.5;... % -Cm_factor*(.6:.05:.7);... % Cm_factor*(0:-.015:-.15);... % -7:-.1:-11;... % -7.5;... % 3.5*Cm_Ben*(-.15:-.015:-.3)/.25;... %
           'deepRS', 'PPduty', .25;...
           'deepRS', 'kernel_type', 25;... % 7;... %
           'deepRS', 'PPnorm', 0;... % 1;...
           'deepRS', 'FMPstim', 0;...
           'deepRS', 'Inoise', .05:.05:.25;...
           };
