...
spec.populations(i).mechanism_list = {'IBitonic','IBnoise','IBiNaF','IBiKDR','IBiAR','IBiM','IBiCaH','IBleak'};
...
spec.populations(i).size = N;
spec.populations(i).equations = {['V''=(current)/Cm; V(0)=' num2str(IC_V) ]};
spec.populations(i).mechanism_list = {'IBdbiPoissonExp','IBitonic','IBnoise','IBiNaF','IBiKDR','IBiAR','IBiM','IBiCaH','IBleak'};
...
spec.populations(i).size = N;
spec.populations(i).equations = {['V''=(current)/Cm; V(0)=' num2str(IC_V) ]};
spec.populations(i).mechanism_list = {'IBitonic','IBnoise','IBiNaF','IBiKDR','IBiM','IBleak'};
spec.populations(i).parameters = {...
