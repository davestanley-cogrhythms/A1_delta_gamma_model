...
for m = 1:length(model_vary)
    ...
    sim_struct = init_sim_struct('vary', vary, 'include_deepRS', 1,...
        ...
        'analysis_functions', {@phase_metrics}, 'analysis_options', {'v_field', 'deepFS_V'},...
        'note', ['Periodic pulse input simulations for model ', model_names{m}],...
        'parent', data_name{m});
...
sim_name = sprintf('PLV_sims_%s_%d', Today, Now(4));
