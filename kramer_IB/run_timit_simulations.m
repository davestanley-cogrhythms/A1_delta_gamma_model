function run_timit_simulations
...
cochlearBands = cochlearBands(:, 4:8:end); %8:16:end); % 

simulation_vary = {%'deepRS', 'mechanism_list', '+iSpeechInput';...
    'deepRS', 'SentenceIndex', .05:.05:1;... .2:.2:1;... 
    'deepRS', 'gSpeech', 0:.1:2;... 0.1:0.1:0.5;... 
...
for m = 1:length(model_vary)
    ...
    sim_struct = init_sim_struct('vary', vary, 'include_deepRS', 1,...
        ...
        'analysis_functions', {@phase_metrics}, 'analysis_options',...
