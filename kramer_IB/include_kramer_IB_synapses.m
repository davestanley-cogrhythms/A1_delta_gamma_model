...
if include_IB
    % Note: Rd and Rr aren't used with this iNMDA synaptic mechanism.
    % Rather, they are left over from when I was using iNMDADestexhe1998Markov.mech
    i=i+1;
...
if include_deepRS && NdeepRS > 1
    ...
    spec.connections(i).parameters = {'g_SYN',gAMPA_deepRSdeepRS,'E_SYN',EAMPA,'tauDx',tauAMPAd,...
        ...
        'gNMDA',gNMDA_deepRSdeepRS,'ENMDA',EAMPA,'tauNMDAr',tauNMDAr_Ben,'tauNMDA',tauNMDAd_Ben ...
        'g_GAP',ggjadeepRS,...
        };
end
...
if include_IB && include_deepRS
    ...
    spec.connections(i).parameters = {'g_SYN',gAMPA_IBdeepRS,'E_SYN',EAMPA,'tauDx',tauAMPAd,...
        'tauRx',tauAMPAr,'fanout',inf,'IC_noise',0,'g_SYN_hetero',gsyn_hetero, ...
        'gNMDA',gNMDA_IBdeepRS,'ENMDA',EAMPA,'tauNMDAr',tauNMDAr_Ben,'tauNMDA',tauNMDAd_Ben ...
        };
end
...
if include_IB && include_deepFS
    ...
    spec.connections(i).parameters = {'g_SYN',gAMPA_IBdeepFS,'E_SYN',EAMPA,'tauDx',tauAMPAd,...
        'tauRx',tauAMPAr,'fanout',inf,'IC_noise',0,'g_SYN_hetero',gsyn_hetero, ...
        'gNMDA',gNMDA_IBdeepFS,'ENMDA',EAMPA,'tauNMDAr',tauNMDAr_Ben,'tauNMDA',tauNMDAd_Ben ...
        };
end
