...
if include_NG
    ...
    spec.populations(i).mechanism_list = {'iPeriodicPulsesiSYNNested','itonicPaired','IBnoise','FSiNaF','FSiKDR','IBleak','iAhuguenard'};
...
if include_IB
    ...
    spec.populations(i).equations = {['V''=@current/Cm; V(0)=' num2str(IC_V) ]};
    spec.populations(i).mechanism_list = {'iPeriodicPulsesiSYNNested','IBdbiPoissonExpJason','itonicPaired','IBnoise','IBiNaF','IBiKDR','IBiMMich','IBiCaH','IBleak','IBleak2'};
    spec.populations(i).parameters = {...
