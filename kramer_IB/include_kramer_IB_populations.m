...
if include_IB
    ...
    spec.populations(i).parameters = {...
      ...
      'PPfreq', PPfreq,'PPwidth', 0.25,'PPshift',PPshift,'PPonset', PPonset, 'PPoffset', PPoffset, 'ap_pulse_num', ap_pulse_num, 'ap_pulse_delay', ap_pulse_delay,'pulse_train_preset',pulse_train_preset,'kernel_type', kernel_type, 'width2_rise', width2_rise,...
        'PP_gSYN',IB_PP_gSYN,'E_SYN',EAMPA,'tauRx',width2_rise,'tauDx',PPwidth,'PP_g_SYN_hetero',gsyn_hetero,...
...
if include_RS
    ...
    spec.populations(i).parameters = {...
      ...
      'PPfreq', PPfreq,'PPwidth', 0.25,'PPshift',PPshift,'PPonset', PPonset, 'PPoffset', PPoffset, 'ap_pulse_num', ap_pulse_num, 'ap_pulse_delay', ap_pulse_delay,'pulse_train_preset',pulse_train_preset,'kernel_type', kernel_type, 'width2_rise', width2_rise,...
        'PP_gSYN',RS_PP_gSYN,'E_SYN',EAMPA,'tauRx',width2_rise,'tauDx',PPwidth,'PP_g_SYN_hetero',gsyn_hetero,...
...
if include_NG
    ...
    spec.populations(i).parameters = {...
      ...
      'PPfreq', PPfreq,'PPwidth', 0.25,'PPshift',PPshift,'PPonset', PPonset, 'PPoffset', PPoffset, 'ap_pulse_num', ap_pulse_num, 'ap_pulse_delay', ap_pulse_delay,'pulse_train_preset',pulse_train_preset,'kernel_type', kernel_type, 'width2_rise', width2_rise,...
        'PP_gSYN',NG_PP_gSYN,'E_SYN',EAMPA,'tauRx',width2_rise,'tauDx',PPwidth,'PP_g_SYN_hetero',gsyn_hetero,...
...
%         ap_pulse_num = ap_pulse_num + 1;
    ...
    spec.populations(i).parameters = {...
      ...
      'PPfreq', PPfreq,'PPwidth', 0.25,'PPshift',PPshift,'PPonset', PPonset, 'PPoffset', PPoffset, 'ap_pulse_num', ap_pulse_num, 'ap_pulse_delay', ap_pulse_delay,'pulse_train_preset',pulse_train_preset,'kernel_type', kernel_type, 'width2_rise', width2_rise,...
        'PP_gSYN',FS_PP_gSYN,'E_SYN',EAMPA,'tauRx',width2_rise,'tauDx',PPwidth,'PP_g_SYN_hetero',gsyn_hetero,...
...
if include_LTS
    ...
    spec.populations(i).equations = {['V''=@current/Cm; V(0)=' num2str(IC_V) ]};
    spec.populations(i).mechanism_list = {'iPeriodicPulsesiSYN','IBitonic','IBnoise','FSiNaF','FSiKDR','IBiMMich','IBleaknoisy'};
    spec.populations(i).parameters = {...
      'V_IC',-65,'IC_noise',IC_noise,'Cm',Cm,'E_l',-67,'E_l_std',LTS_Eleak_std,'g_l',0.1,...
      'PPfreq', PPfreq,'PPwidth', 0.25,'PPshift',PPshift,'PPonset', PPonset, 'PPoffset', PPoffset, 'ap_pulse_num', ap_pulse_num, 'ap_pulse_delay', ap_pulse_delay,'pulse_train_preset',pulse_train_preset,'kernel_type', kernel_type, 'width2_rise', width2_rise,...
        'PP_gSYN',LTS_PP_gSYN,'E_SYN',EAMPA,'tauRx',width2_rise,'tauDx',PPwidth,'PP_g_SYN_hetero',gsyn_hetero,...
