...
if include_NG
    ...
    spec.populations(i).mechanism_list = {'iPeriodicPulsesiSYNNested','itonicPaired','IBnoise','FSiNaF','FSiKDR','IBleaknoisy','iAhuguenard'};
...
if include_LTS
    ...
    spec.populations(i).equations = {['V''=@current/Cm; V(0)=' num2str(IC_V) ]};
    spec.populations(i).mechanism_list = {'iPeriodicPulsesiSYNNested','itonicPaired','IBnoise','FSiNaF','FSiKDR','IBiMMich','IBleaknoisy'};
    spec.populations(i).parameters = {...
...
if include_RS
    ...
    spec.populations(i).equations = {['V''=@current/Cm; V(0)=' num2str(IC_V) ]};
    spec.populations(i).mechanism_list = {'iPeriodicPulsesiSYNNested','IBdbiPoissonExpJason','itonicPaired','IBnoise','IBiNaF','IBiKDR','IBiMMich','IBiCaH','IBleaknoisy'};
    spec.populations(i).parameters = {...
