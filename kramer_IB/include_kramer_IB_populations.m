...
% % This script adds all the cell populations % %
...
if include_IB
    ...
    spec.populations(i).parameters = {...
      ...
      'kernel_type', kernel_type, 'width2_rise', width2_rise,'PPFacTau',PPFacTau,'PPFacFactor',IBPPFacFactor,...
...
if include_RS
    ...
    spec.populations(i).parameters = {...
      ...
      'PPonset', PPonset, 'PPoffset', PPoffset, 'ap_pulse_num', ap_pulse_num,...
      'ap_pulse_delay', ap_pulse_delay,'pulse_train_preset',pulse_train_preset,...
      'kernel_type', kernel_type, 'width2_rise', width2_rise,'PPFacTau',RSPPFacTau,'PPFacFactor',RSPPFacFactor,...
...
if include_NG
    ...
    spec.populations(i).parameters = {...
      ...
      'PPstim',NGPPstim,'PPfreq',PPfreq,'PPwidth',PPwidth,'PPshift',PPshift,'PPonset',PPonset,...
      'PPoffset',PPoffset,'ap_pulse_num',ap_pulse_num,'ap_pulse_delay',ap_pulse_delay,...
      'pulse_train_preset',pulse_train_preset,'kernel_type', kernel_type, 'width2_rise', width2_rise,...
      'PPFacTau',PPFacTau,'PPFacFactor',PPFacFactor,...
...
if include_FS
    ...
    spec.populations(i).parameters = {...
      ...
      'PPstim',FSPPstim,'PPfreq',PPfreq,'PPwidth',PPwidth,'PPshift',PPshift,'PPonset',PPonset,...
      'PPoffset',PPoffset,'ap_pulse_num',ap_pulse_num,'ap_pulse_delay',ap_pulse_delay,...
      'pulse_train_preset',pulse_train_preset,'kernel_type', kernel_type, 'width2_rise', width2_rise,...
      'PPFacTau',PPFacTau,'PPFacFactor',PPFacFactor,...
