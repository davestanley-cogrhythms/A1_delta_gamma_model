...
if include_deepRS
    ...
    %spec.populations(i).mechanism_list = {'iNaP','iKs','iKDRG','iNaG','iLeak','CaDynT','iCaT','iKCaT','itonicBen'};
    spec.populations(i).mechanism_list = {'iNaP','iKs','iKDRG','iNaG','iLeak',...
        'CaDynT','iCaT','iKCaT','iPeriodicPulsesBen','itonicBen','iFMPulses'}; % , 'iSpikeTriggeredPulse'}; % , 'VaryRandomSeed'}; % 'iPeriodicSpikes',
    spec.populations(i).parameters = {...
