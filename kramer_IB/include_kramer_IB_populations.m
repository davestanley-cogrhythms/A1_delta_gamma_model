...
if include_deepRS
    ...
    spec.populations(i).mechanism_list = {'iNaP','iKs','iKsConst','iKDRG','iNaG','iLeak',...
        'CaDynT','iCaT','iKCaT','iPeriodicPulsesBen','itonicBen', 'iSpeechInput', 'iStimInput', 'iVariedPulses'}; %,'iFMPulses'}; %,...'iCarracedoEPSPs'}; % 'iSpikeTriggeredPulse',, 'VaryRandomSeed'}; % 'iPeriodicSpikes',
    spec.populations(i).parameters = {...
