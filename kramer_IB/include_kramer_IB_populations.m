...
if include_IB
    ...
    spec.populations(i).parameters = {...
      ...
      'E_l2',EGABA,'g_l2',0,...
      'PPfreq', PPfreq,'PPwidth', IB_PP_width,'PPshift',PPshift,'PPonset', PPonset, 'PPoffset', PPoffset, 'ap_pulse_num', ap_pulse_num, 'ap_pulse_delay', ap_pulse_delay,'pulse_train_preset',pulse_train_preset,'kernel_type', kerneltype_IB, 'width2_rise', PPwidth2_rise,...
        ...
        'poissScaling',poissScaling,'poissTau',poissTau,...
...
if include_RS
    ...
    spec.populations(i).parameters = {...
      ...
      'PPfreq', PPfreq,'PPwidth', IB_PP_width,'PPshift',PPshift,'PPonset', PPonset, 'PPoffset', PPoffset, 'ap_pulse_num', ap_pulse_num, 'ap_pulse_delay', ap_pulse_delay,'pulse_train_preset',pulse_train_preset,'kernel_type', kerneltype_L4, 'width2_rise', PPwidth2_rise,...
