...
if include_IB
    ...
    spec.populations(i).mechanism_list = {'iPeriodicPulsesiSYN','iPeriodicPulsesiNMDADestexhe1998Markov.mech','IBdbiPoissonExpJason','itonicPaired','IBnoise','IBiNaF','IBiKDR','IBiMMich','IBiCaH','IBleak','IBleak2'};
    spec.populations(i).parameters = {...
      ...
      'PPfreq', PPfreq,'PPwidth', 0.25,'PPshift',PPshift,'PPonset', PPonset, 'PPoffset', PPoffset, 'ap_pulse_num', ap_pulse_num, 'ap_pulse_delay', ap_pulse_delay,'pulse_train_preset',pulse_train_preset,'kernel_type', kernel_type, 'width2_rise', width2_rise,...
        'PP_gSYN',IB_PP_gSYN,'E_SYN',EAMPA,'tauRx',width2_rise,'tauDx',PPwidth,...
...
if include_NG
    ...
    spec.populations(i).parameters = {...
      ...
      'PPfreq', PPfreq,'PPwidth', 0.25,'PPshift',PPshift,'PPonset', PPonset, 'PPoffset', PPoffset, 'ap_pulse_num', ap_pulse_num, 'ap_pulse_delay', ap_pulse_delay,'pulse_train_preset',pulse_train_preset,'kernel_type', kernel_type, 'width2_rise', width2_rise,...
        'PP_gSYN',NG_PP_gSYN,'E_SYN',EAMPA,'tauRx',width2_rise,'tauDx',PPwidth,...
