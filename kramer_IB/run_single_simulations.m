function run_single_simulations
...
data_name = {'18-12-21/kramer_IB_13_46_54.96';...
    ...
    '19-07-19/kramer_IB_16_50_25.92';... % 
...
simulation_vary = {'deepRS', 'PPstim', 0;...
    };
...
for m = 1:length(model_vary)
    ...
    sim_struct = init_sim_struct('vary', vary, 'include_deepRS', 1,...
        ...
        'cluster_flag', 0, 'parallel_flag', 0, 'save_data_flag', 1, 'sim_mode', 3,...
...
sim_name = sprintf('single_%s_%d', Today, Now(4));
